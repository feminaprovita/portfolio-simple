module.exports =  [ { name: 'Portfolio Website',
    role: 'Engineer',
    bullets:
    ...
    hold:
     [ 'https://medium.com/@feminaprovita/things-i-learned-building-my-portfolio-site-7abb472599ae',
       'https://github.com/feminaprovita/portfolio-simple' ],
    links:
     'https://medium.com/@feminaprovita/things-i-learned-building-my-portfolio-site-7abb472599ae   ❦   https://github.com/feminaprovita/portfolio-simple' },
  { name: 'Masks Google Plus Rescue',
    ...
    hold:
     [ 'https://medium.com/@feminaprovita/pair-programming-after-bootcamp-unintentionally-a-great-learning-experience-2201223413d',
       'https://github.com/feminaprovita/masks-rescue' ],
    links:
     'https://medium.com/@feminaprovita/pair-programming-after-bootcamp-unintentionally-a-great-learning-experience-2201223413d   ❦   https://github.com/feminaprovita/masks-rescue' },
  { name: 'Moodify',
    ...
    hold:
     [ '<a href=https://my-moodify.herokuapp.com target="blank">Website</a>',
       'https://github.com/grape-emu/my-moodify',
       'http://bit.ly/moodify-presentation' ],
    links:
     '<a href=https://my-moodify.herokuapp.com target="blank">Website</a>   ❦   https://github.com/grape-emu/my-moodify   ❦   http://bit.ly/moodify-presentation' },
  { name: 'Timelink Travel Services',
    ...
    hold:
     [ '<a href=https://pm-grace-shopper.herokuapp.com target="blank">Website</a>',
       'https://github.com/pigMercury/grace-shopper' ],
    links:
     '<a href=https://pm-grace-shopper.herokuapp.com target="blank">Website</a>   ❦   https://github.com/pigMercury/grace-shopper' },
  { name: 'Keeping Facebook Cheerful',
    ...
    hold:
     [ 'https://github.com/feminaprovita/kfbc-website',
       'http://bit.ly/kfbc' ],
    links:
     'https://github.com/feminaprovita/kfbc-website   ❦   http://bit.ly/kfbc' } ]
